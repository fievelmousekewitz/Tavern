================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Tavern Project Overview
===============================================================================

The application wizard has created this Tavern application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Tavern application.
...
Tavern.h
    ...
    project specific headers and declares the CTavernApp application class.
...
TavernDlg.h, TavernDlg.cpp - the dialog
    These files contain your CTavernDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Tavern.pch and a precompiled types file named StdAfx.obj.
