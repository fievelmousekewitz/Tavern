...
BEGIN_MESSAGE_MAP(WIPStart, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON8, &WIPStart::OnBnClickedButton8)
	ON_BN_CLICKED(IDC_BUTTON9, &WIPStart::OnBnClickedButton9)
	ON_BN_CLICKED(IDC_BUTTON11, &WIPStart::OnBnClickedButton11)
	ON_BN_CLICKED(IDC_BUTTON10, &WIPStart::OnBnClickedButton10)
END_MESSAGE_MAP()
...
BOOL WIPStart::OnInitDialog()
{
	...
	SetDlgItemText(IDC_BUTTON8,L"KITCUT ("+theApp.wipresetdlg.DeptScanToText(theApp.wipresetdlg.CountDepartmentScans(L"KIT CUTTING"))+L')');
	SetDlgItemText(IDC_BUTTON9,L"QAQ ("+theApp.wipresetdlg.DeptScanToText(theApp.wipresetdlg.CountDepartmentScans(L"QAQ"))+L')');
	SetDlgItemText(IDC_BUTTON11,L"AS2/WTB ("+theApp.wipresetdlg.DeptScanToText(theApp.wipresetdlg.CountDepartmentScans(L"WTB"))+L')');
	SetDlgItemText(IDC_BUTTON10,L"PRR ("+theApp.wipresetdlg.DeptScanToText(theApp.wipresetdlg.CountDepartmentScans(L"PRR"))+L')');
...
void WIPStart::OnBnClickedButton8()
{
	theApp.wipdepartment = L"KIT CUTTING";
	GetDlgItemText(IDC_EDIT1,theApp.employeeid);
	theApp.defaultid = theApp.employeeid;
	UnregisterHotKey(this->m_hWnd,100);
	UnregisterHotKey(this->m_hWnd,200);
...
void WIPStart::OnBnClickedButton9() //QAQ
{
	theApp.wipdepartment = L"QAQ";
	GetDlgItemText(IDC_EDIT1,theApp.employeeid);
	theApp.defaultid = theApp.employeeid;
	UnregisterHotKey(this->m_hWnd,100);
	UnregisterHotKey(this->m_hWnd,200);
...
void WIPStart::OnBnClickedButton11() //AS2 / WTB
{
	theApp.wipdepartment = L"WTB";
	GetDlgItemText(IDC_EDIT1,theApp.employeeid);
	theApp.defaultid = theApp.employeeid;
	UnregisterHotKey(this->m_hWnd,100);
	UnregisterHotKey(this->m_hWnd,200);
...
void WIPStart::OnBnClickedButton10() //PRR
{
theApp.wipdepartment = L"PRR";
	GetDlgItemText(IDC_EDIT1,theApp.employeeid);
	theApp.defaultid = theApp.employeeid;
	UnregisterHotKey(this->m_hWnd,100);
	UnregisterHotKey(this->m_hWnd,200);
